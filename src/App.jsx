    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-800 text-xs mt-3">2026 Specter LSAT Prep. Not affiliated with LSAC.</p>
        </div>
        ...
        <div id="app-download-section" className="bg-white rounded-2xl shadow-2xl p-12 mb-16">
          <h2 className="text-4xl font-bold text-gray-900 text-center mb-4">Download the App</h2>
          <p className="text-gray-600 text-center mb-8">Add Specter to your home screen for instant access — no App Store required.</p>
          <div className="flex gap-3 justify-center mb-8">
            <button onClick={()=>setInstallPlatform('ios')} className={`flex items-center gap-2 px-6 py-3 rounded-xl font-semibold border-2 transition-all ${installPlatform==='ios'?'border-indigo-600 text-indigo-600 bg-indigo-50':'border-gray-300 text-gray-500 hover:border-gray-400'}`}>
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>
              iPhone / iPad
            </button>
            <button onClick={()=>setInstallPlatform('android')} className={`flex items-center gap-2 px-6 py-3 rounded-xl font-semibold border-2 transition-all ${installPlatform==='android'?'border-indigo-600 text-indigo-600 bg-indigo-50':'border-gray-300 text-gray-500 hover:border-gray-400'}`}>
          ...
          <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
            <p className="text-xs font-bold text-indigo-600 uppercase tracking-widest mb-5">
            ...
            {installPlatform === 'ios' ? (
              <div className="space-y-3">
                {[
                  ...
                  <div key={n} className="flex items-center gap-4 bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                    <div className="w-9 h-9 rounded-full bg-indigo-600 text-white font-bold text-sm flex items-center justify-center flex-shrink-0">{n}</div>
                    <p className="text-gray-700 text-sm flex-1">{text}</p>
                    <span className="text-indigo-400 text-lg flex-shrink-0 font-bold">{icon}</span>
                  </div>
                ))}
              </div>
            ) : (
          ...
          <div className="bg-white rounded-2xl max-w-3xl w-full p-6 md:p-10 shadow-2xl my-4 md:my-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-6 md:mb-8">
              <div className="border-2 border-gray-200 rounded-2xl p-6 md:p-8 hover:border-indigo-300 transition-all">
                ...
                <div className="mb-4 md:mb-6"><span className="text-5xl md:text-6xl font-bold text-gray-900">$20</span><span className="text-xl text-gray-500">/month</span></div>
              ...
              <div className="border-2 border-indigo-500 rounded-2xl p-6 md:p-8 bg-gradient-to-br from-indigo-50 to-purple-50 relative mt-4 md:mt-0">
                ...
                <div className="mb-4 md:mb-6"><span className="text-5xl md:text-6xl font-bold text-gray-900">$25</span><span className="text-xl text-gray-500">/month</span></div>
            ...
            <div className="bg-gray-50 rounded-xl p-4 md:p-6 text-center mb-4">
              ...
              <p className="text-gray-400 text-xs mt-2">Refunds may be provided under certain conditions. Cancel anytime to stop future charges. Governed by the laws of Florida, USA.</p>
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-lg w-full p-8 shadow-2xl">
            <div className="flex justify-between items-center mb-6">
              ...
              <button onClick={()=>setShowPrivacy(false)} className="text-gray-400 hover:text-gray-600 text-2xl font-bold leading-none">x</button>
            </div>
            <div className="text-sm text-gray-700 space-y-4 max-h-96 overflow-y-auto pr-2">
              ...
              <div><p className="font-bold text-gray-800 mb-1">1. Information We Collect</p><p>We collect your username, email address, and password when you create an account. We also collect your practice test scores, drill history, and progress data to provide our service.</p></div>
              <div><p className="font-bold text-gray-800 mb-1">2. How We Use Your Information</p><p>We use your information to operate and improve Specter LSAT Prep, process your subscription payments through Stripe, and communicate with you about your account. We do not sell your personal information to third parties.</p></div>
              <div><p className="font-bold text-gray-800 mb-1">3. Data Storage</p><p>Your account information is stored securely in Supabase, a cloud database service. Payment processing is handled entirely by Stripe. We do not store your credit card information.</p></div>
              <div><p className="font-bold text-gray-800 mb-1">4. Passwords</p><p>Your password is stored in our database. We strongly recommend using a unique password for your Specter account. We will never ask for your password via email.</p></div>
              <div><p className="font-bold text-gray-800 mb-1">5. Cookies and Local Storage</p><p>We use your browser's local storage to keep you logged in between sessions. We do not use third-party tracking cookies.</p></div>
              <div><p className="font-bold text-gray-800 mb-1">6. Third-Party Services</p><p>We use Stripe for payment processing, Supabase for data storage, and Vercel for hosting. Each has their own privacy policy governing their use of data.</p></div>
              <div><p className="font-bold text-gray-800 mb-1">7. Your Rights</p><p>You may request deletion of your account and associated data at any time by emailing specterlsatprep@gmail.com. We will process deletion requests within 30 days.</p></div>
              <div><p className="font-bold text-gray-800 mb-1">8. Children's Privacy</p><p>Specter LSAT Prep is not directed at children under 13. We do not knowingly collect personal information from children under 13.</p></div>
              <div><p className="font-bold text-gray-800 mb-1">9. Changes to This Policy</p><p>We may update this Privacy Policy from time to time. Continued use of the service after changes constitutes acceptance of the updated policy.</p></div>
              <div><p className="font-bold text-gray-800 mb-1">10. Contact</p><p>For privacy-related questions, contact us at specterlsatprep@gmail.com.</p></div>
            </div>
            <button onClick={()=>setShowPrivacy(false)} className="w-full mt-6 bg-indigo-600 text-white py-3 rounded-lg font-semibold hover:bg-indigo-700">Close</button>
          </div>
        </div>
      )}
      {showTerms && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4"><div className="bg-white rounded-2xl max-w-md w-full p-8 shadow-2xl"><h2 className="text-2xl font-bold mb-4">Terms of Service</h2><div className="text-sm text-gray-700 space-y-3 max-h-64 overflow-y-auto"><p><strong>1. Agreement.</strong> By using Specter LSAT Prep, you agree to these Terms of Service.</p><p><strong>2. Subscriptions.</strong> Test Access ($20/mo) provides access to all practice questions and tests. Premium ($25/mo) adds detailed answer explanations. Subscriptions renew monthly until cancelled.</p><p><strong>3. Refunds.</strong> Refunds may be provided under certain conditions. Contact us at specterlsatprep@gmail.com within 7 days of purchase to request a refund.</p><p><strong>4. Cancellations.</strong> You may cancel your subscription at any time through the Stripe customer portal. Access continues until the end of your billing period.</p><p><strong>5. Account Responsibility.</strong> You are responsible for maintaining the confidentiality of your account credentials. You may not share your account with others.</p><p><strong>6. Intellectual Property.</strong> All content on Specter LSAT Prep is proprietary. You may not reproduce or distribute it without permission.</p><p><strong>7. Disclaimer.</strong> Specter LSAT Prep is an independent test preparation service. We are not affiliated with or endorsed by LSAC.</p><p><strong>8. Governing Law.</strong> These terms are governed by the laws of Florida, USA.</p><p><strong>9. Contact.</strong> specterlsatprep@gmail.com</p></div><button onClick={()=>setShowTerms(false)} className="w-full mt-6 bg-indigo-600 text-white py-3 rounded-lg font-semibold hover:bg-indigo-700">Close</button></div></div>}
    </div>
  );
  ...
  if (!user) return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
        ...
        <div className="mt-3 text-center flex items-center justify-center gap-4"><button onClick={()=>setShowTerms(true)} className="text-xs text-gray-500 underline">Terms of Service</button><button onClick={()=>setShowPrivacy(true)} className="text-xs text-gray-500 underline">Privacy Policy</button></div>
      </div>
    </div>
  );
      ...
      return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-8 flex items-center justify-center">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-10 text-center">
            ...
            <button onClick={()=>upgrade(true)} className="w-full bg-indigo-600 text-white py-3 rounded-lg font-semibold hover:bg-indigo-700 mb-3">Upgrade to Premium -- $25/month</button>
                ...
                {isPremium ? (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <button onClick={()=>upgrade(true)} className="bg-indigo-600 text-white px-5 py-2 rounded-lg font-semibold text-sm hover:bg-indigo-700">Upgrade to Premium - $25/month</button>
                    </div>
                  </div>
                )}
              </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-4 mb-8 flex flex-wrap justify-between items-center gap-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {user.isAdmin && <button onClick={()=>{setShowAdmin(true);setAdminSearch('');setAdminResult(null);setAdminMsg('');}} className="flex items-center gap-2 px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-900 text-sm font-semibold"><User className="w-4 h-4"/>Admin Panel</button>}
              ...
              <button onClick={()=>setShowTerms(true)} className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 text-sm">Terms</button><button onClick={()=>setShowPrivacy(true)} className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 text-sm">Privacy</button>
          ...
          <div className="bg-white rounded-2xl max-w-lg w-full p-8 shadow-2xl">
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">Manage user subscriptions</p>
              </div>
              <button onClick={()=>setShowAdmin(false)} className="text-gray-400 hover:text-gray-600 text-2xl font-bold leading-none">x</button>
            </div>

            <div className="mb-6">
              <label className="block text-sm font-semibold text-gray-700 mb-2">Look Up User by Username</label>
              <div className="flex gap-2">
                <input type="text" value={adminSearch} onChange={e=>setAdminSearch(e.target.value)} placeholder="Enter username or email" className="flex-1 px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-indigo-500 focus:outline-none"/>
                ...
                }} className="bg-indigo-600 text-white px-5 py-2 rounded-lg font-semibold hover:bg-indigo-700">Search</button>
              </div>
              ...
              <div className="border-2 border-gray-200 rounded-xl p-5">
                <div className="grid grid-cols-2 gap-3 mb-5">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3">
                    <p className="text-xs text-gray-500 font-semibold uppercase tracking-wide mb-1">Current Plan</p>
                    {adminResult.isPremium ? <span className="bg-yellow-400 text-gray-900 text-xs px-2 py-0.5 rounded-full font-bold">Premium</span>
                    : adminResult.hasTestAccess ? <span className="bg-indigo-100 text-indigo-700 text-xs px-2 py-0.5 rounded-full font-bold">Test Access</span>
                    : <span className="bg-gray-100 text-gray-600 text-xs px-2 py-0.5 rounded-full font-bold">Free</span>}
                  </div>
                </div>

                <p className="text-sm font-semibold text-gray-700 mb-3">Update Subscription</p>
                <div className="grid grid-cols-3 gap-2 mb-3">
                  ...
                  }} className="bg-indigo-600 text-white py-2 rounded-lg font-semibold text-sm hover:bg-indigo-700">Premium</button>
                  <button onClick={async ()=>{
                    try {
            ...
            <div className={`rounded-lg p-6 mb-6 border-2 ${user.isPremium&&isDone?"bg-blue-50 border-blue-200":"bg-indigo-50 border-indigo-200"}`}>
              {user.isPremium&&isDone?(<>
                ...
                <div className="flex items-start gap-4"><Lock className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1"/>
                  ...
                  {isDone&&<button onClick={()=>setShowPaywall(true)} className="bg-indigo-600 text-white px-6 py-2 rounded-lg font-semibold text-sm hover:bg-indigo-700">Unlock Explanations -- $25/month</button>}</div>
                </div>
              )}
            </div>
          )}
